...
export const metadata: Metadata = {
  title: 'Editar Producto — GABLIMADOS',
}
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <h2 className="text-2xl font-black text-gray-900 dark:text-white">Editar Producto ✏️</h2>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">{producto.nombre}</p>
      </div>
      ...
      <ProductoForm
        ...
        producto={{
          ...
          costoInsumo: Number(producto.costoInsumo),
          costoPapel: Number(producto.costoPapel),
          costoTinta: Number(producto.costoTinta),
          costoElectrico: Number(producto.costoElectrico),
